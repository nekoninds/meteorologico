							...
							<div class="content col-md-8">
										...
										<div class="forecast2-container" style="margin-top: 30px">
											...
											<div class="forecast">
												...
												<div class="forecast-content">
													<div>
														<?php
															$Prom6="SELECT AVG(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima' AND fecha = '".date("Y-m-d ", $time - 518400)."' ORDER BY idDato";
													...
													<div>
														<?php
															$Mayor6="SELECT MAX(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 518400)."'";
													...
													<div>
														<?php
															$Menor6="SELECT MIN(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time -518400)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
											...
											<div class="forecast">
												...
												<div class="forecast-content">
													<div>
														<?php
															$Prom5="SELECT AVG(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima' AND fecha = '".date("Y-m-d ", $time - 432000)."' ORDER BY idDato";
													...
													<div>
														<?php
															$Mayor5="SELECT MAX(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 432000)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
													...
													<div>
														<?php
															$Menor5="SELECT MIN(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 432000)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
											...
											<div class="forecast">
												...
												<div class="forecast-content">
													<div>
														<?php
															$Prom4="SELECT AVG(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima' AND fecha = '".date("Y-m-d ", $time - 345600)."' ORDER BY idDato";
													...
													<div>
														<?php
															$Mayor4="SELECT MAX(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 345600)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
													...
													<div>
														<?php
															$Menor4="SELECT MIN(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 345600)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
											...
											<div class="forecast">
												...
												<div class="forecast-content">
													<div>
														<?php
															$Prom3="SELECT AVG(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima' AND fecha = '".date("Y-m-d ", $time - 259200)."' ORDER BY idDato";
													...
													<div>
														<?php
															$Mayor3="SELECT MAX(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 259200)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
													...
													<div>
														<?php
															$Menor3="SELECT MIN(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 259200)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
											...
											<div class="forecast">
												...
												<div class="forecast-content">
													<div>
														<?php
															$Prom2="SELECT AVG(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima' AND fecha = '".date("Y-m-d ", $time - 172800)."' ORDER BY idDato";
													...
													<div>
														<?php
															$Mayor2="SELECT MAX(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 172800)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
													...
													<div>
														<?php
															$Menor2="SELECT MIN(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 172800)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
											...
											<div class="forecast">
												...
												<div class="forecast-content">
													...
													<div>
														<?php
															$Prom = "SELECT AVG(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima' AND fecha = '".date("Y-m-d ", $time - 86400)."'";
													...
													<div>
														<?php
															$Mayor="SELECT MAX(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 86400)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
													...
													<div>
														<?php
															$Menor="SELECT MIN(dato) FROM datos WHERE idSensor = '1' AND ubicacion = 'colima'AND fecha = '".date("Y-m-d ", $time - 86400)."'";
															//$ultimo = "SELECT MAX(idDato) FROM datos WHERE idSensor = '1'";
											...
											<div class="today forecast" style="width: 210px;">
												...
												<div class="forecast-content">
													...
													<div class="degree">
														<div >
															<?php
																$ultTemp="SELECT * FROM datos WHERE idSensor = '1' AND ubicacion = 'colima' AND fecha = '".date("Y-m-d ", $time)."' ORDER BY idDato desc limit 1";
								...
								<div class="entry-content">
										...
										<div class="forecast2-container" style="margin-top: 30px; padding: 20px 30px;">
												...
												<div class="forecast-content">
													<div class="location">Colima</div><br>
													<div class="degree">
														<div >
															<?php
