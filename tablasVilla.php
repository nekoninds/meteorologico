			...
			<main class="main-content">
				<div class="container">
					<div class="breadcrumb">
						...
						<a href="villa.php">Campus Villa de Alvarez</a>
						<span>Tablas</span>
					</div>
				</div>
						...
						<div class="row">
							<div class="content col-md-8">
								<div class="post single">
									<h2 class="entry-title">Campus villa de Alvarez</h2>
										...
										<table>
											...
											<?php
												...
												{
													$datos = "SELECT *  FROM datos WHERE ubicacion = 'villa' order by idSensor";
												}
												else if(isset($_GET["byFecha"]))
												{
													$datos = "SELECT *  FROM datos WHERE ubicacion = 'villa' order by fecha asc";
												}
												else
												{
													$datos = "SELECT *  FROM datos WHERE ubicacion = 'villa'";
												}
								...
								if (isset($_SESSION['nickname']))
								{
									...
									<div class='widget' style='margin-top: 54px'>
										...
										<ul class='arrow-list'>
											...
											<li><a href='tablasVilla.php?bySensor'>Sensor</a></li>
											<li><a href='tablasVilla.php?byFecha'>Fecha</a></li>
											
											<li><a href='tablasVilla.php'>ID</a></li>
										</ul>
									</div>";
