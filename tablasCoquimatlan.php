			...
			<main class="main-content">
				<div class="container">
					<div class="breadcrumb">
						...
						<a href="coquimatlan.php">Campus Coquimatlan</a>
						<span>Tablas</span>
					</div>
				</div>
						...
						<div class="row">
							<div class="content col-md-8">
								<div class="post single">
									<h2 class="entry-title">Campus Coquimatlan</h2>
										...
										<table>
											...
											<?php
												...
												{
													$datos = "SELECT *  FROM datos WHERE ubicacion = 'coquimatlan' order by idSensor";
												}
												else if(isset($_GET["byFecha"]))
												{
													$datos = "SELECT *  FROM datos WHERE ubicacion = 'coquimatlan' order by fecha asc";
												}
												else
												{
													$datos = "SELECT *  FROM datos WHERE ubicacion = 'coquimatlan'";
												}
								...
								if (isset($_SESSION['nickname']))
								{
									...
									<div class='widget' style='margin-top: 54px'>
										...
										<ul class='arrow-list'>
											...
											<li><a href='tablasCoquimatlan.php?bySensor'>Sensor</a></li>
											<li><a href='tablasCoquimatlan.php?byFecha'>Fecha</a></li>
											
											<li><a href='tablasCoquimatlan.php'>ID</a></li>
										</ul>
									</div>";
